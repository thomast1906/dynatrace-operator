...
type ActiveGateSpec struct {
	...
	Capabilities map[CapabilityDisplayName]CapabilityProperties `json:"capabilities"`

	ActiveGateProperties `json:",inline"`
}

// ActiveGateProperties is a struct which can be embedded by ActiveGate specification
// Such as KubernetesMonitoring or Routing
// It encapsulates common properties
type ActiveGateProperties struct {
...
// Such as KubernetesMonitoring or Routing or Statsd
// It encapsulates common properties
