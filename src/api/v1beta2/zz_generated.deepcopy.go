...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ActiveGateProperties) DeepCopyInto(out *ActiveGateProperties) {
	*out = *in
	if in.Replicas != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActiveGateProperties.
func (in *ActiveGateProperties) DeepCopy() *ActiveGateProperties {
	if in == nil {
		return nil
	}
	out := new(ActiveGateProperties)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ActiveGateSpec) DeepCopyInto(out *ActiveGateSpec) {
	*out = *in
	if in.Capabilities != nil {
		...
		*out = make(map[CapabilityDisplayName]CapabilityProperties, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	in.ActiveGateProperties.DeepCopyInto(&out.ActiveGateProperties)
}
...
func (in *DynaKubeSpec) DeepCopyInto(out *DynaKubeSpec) {
	*out = *in
	...
	if in.ActiveGates != nil {
		in, out := &in.ActiveGates, &out.ActiveGates
		*out = make([]ActiveGateSpec, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
