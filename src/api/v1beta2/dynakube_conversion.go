...
/*func convertToDeprecatedActiveGateCapability(dst *v1alpha1.CapabilityProperties, src *ActiveGateProperties) {
	dst.Enabled = true
	...
	/*
		...
		if src.Spec.RoutingSpec.Enabled {
			...
			convertFromDeprecatedActiveGateCapability(
				&dst.Spec.Routing.ActiveGateProperties,
		...
		if src.Spec.KubernetesMonitoringSpec.Enabled {
			...
			convertFromDeprecatedActiveGateCapability(
				&dst.Spec.KubernetesMonitoring.ActiveGateProperties,
...
/*
func convertFromDeprecatedActiveGateCapability(dst *ActiveGateProperties, src *v1alpha1.CapabilityProperties) {
	dst.Replicas = src.Replicas
	dst.Group = src.Group
	if src.CustomProperties != nil {
