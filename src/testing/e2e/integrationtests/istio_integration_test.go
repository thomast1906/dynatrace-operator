...
func TestReconcileOneAgent_ReconcileIstio(t *testing.T) {
	...
	e.AddOneAgent("dynakube", &dynatracev1beta2.DynaKubeSpec{
...
func TestReconcileOneAgent_ReconcileIstioWithMultipleOneAgentObjects(t *testing.T) {
	...
	e.AddOneAgent("oneagent1", &dynatracev1beta2.DynaKubeSpec{
		APIURL:      DefaultTestAPIURL,
		Tokens:      "token-test",
		EnableIstio: true,
		OneAgent: dynatracev1beta2.OneAgentSpec{
	...
	e.AddOneAgent("oneagent2", &dynatracev1beta2.DynaKubeSpec{
		APIURL:      DefaultTestAPIURL,
		Tokens:      "token-test",
		EnableIstio: true,
		OneAgent: dynatracev1beta2.OneAgentSpec{
